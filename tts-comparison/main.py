...
vs.bark("Accessing alarm and interface settings. [laughter] In this window you can set up your customized greeting and alarm preferences [clears throat]. Hello Sir, What can I do for you today? Bark is fully generative text-to-audio model devolved for research and demo purpose.")
